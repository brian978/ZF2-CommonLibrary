...
abstract class AbstractTableGateway extends TableGateway implements TableGatewayInterface
{
     ...
     * @return \Acamar\Model\Db\AbstractTableGateway
     */
    ...
    /**
     * @param \Acamar\Model\Db\Collection\GatewayTracker $tracker
     *
    ...
    /**
     * @return \Acamar\Model\Db\Collection\GatewayTracker
     */
    ...
    /**
     * @param \Acamar\Model\Db\ResultProcessor $processorPrototype
     * @return AbstractTableGateway
     */
    ...
    protected function attachMappers(array $rawJoins, GatewayTracker $tracker)
    {
        if (is_null($tracker)) {
            throw new \InvalidArgumentException(
                'The provided tracker is NULL. Should be instance of \Acamar\Model\Db\Collection\GatewayTracker'
            );
        }
