...
use Acamar\Model\DbModelAwareInterface;
use Acamar\Model\ModelAwareInterface;
...
abstract class AbstractFormController extends AbstractUiController
{
    ...
    {
        /** @var $model \Acamar\Model\AbstractDbModel */
        $model = $this->getModel();
