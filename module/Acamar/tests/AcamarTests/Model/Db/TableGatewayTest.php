...
namespace AcamarTests\Model\Db;

use Acamar\Model\Db\Collection\GatewayTracker;
use Acamar\Model\Db\ResultProcessorInterface;
use Acamar\Model\Db\TableGateway;
...
class TableGatewayTest extends AbstractTest
{
     ...
     *
     * @param \Acamar\Model\Db\TableGateway $tableMock
     */
    public function testGatewayCanUseAttachedMapper($tableMock)
    {
        /** @var $mapperMock \Acamar\Model\Mapper\AbstractMapper */
        $mapperMock = $this->getMockBuilder('\Acamar\Model\Mapper\AbstractMapper')
    ...
    public function testGatewayCanReturnPaginator()
    {
        ...
        /** @var $object \Acamar\Model\Db\ResultProcessor */
